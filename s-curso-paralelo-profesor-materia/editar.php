      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="control-group">
            <label class="control-label">Seleccione Docente-materia: </label>
            <div class="controls">
              <input type="hidden" name="<?= $csrf; ?>">
              <input name="aula_paralelo_id" id="aula_paralelo_id"  type="hidden" >
              <input name="tipoAc" id="tipoAc"  type="hidden" >
              <input name="aula_par_prof_mat_id" id="aula_par_prof_mat_id"  type="hidden" >
...
nombre_materia*/
  ...
  $("#form_gestion").validate({
    ...
    submitHandler: function(form) {
      ...
      $.ajax({
        type: 'POST',
        url: "?/s-curso-paralelo-profesor-materia/guardar",
        data: datos,
        success: function(resp) {
         alert(resp);
          cont = 0;
    ...
    listar_paralelos_tabla();
            ...
            case '3':
              //dataTable.ajax.reload();
              //$("#modal_gestion").modal("hide");
              alertify.warning('La materia ya se asigno anteriormente');
              break;
            default : alertify.error('No se pudo guardar ');
          }
          //pruebaa();
        }
