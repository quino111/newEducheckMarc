...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Asignaciones Curso Profesor Materia </h2>
                             ...
                             <div class="btn-group">
								...
								<div class="input-group-append be-addon">
									...
									<div class="dropdown-menu">
										...
										<?php //if ($permiso_imprimir) : ?>
										<div class="dropdown-divider"></div>
										<a href="?/s-curso-paralelo-profesor-materia/imprimir" class="dropdown-item" target="_blank"><span class="glyphicon glyphicon-print"></span> Exportar Pdf </a>
										<a href="?/s-curso-paralelo-profesor-materia/imprimirexcel" class="dropdown-item" target="_blank"><span class="glyphicon glyphicon-print"></span> Exportar Excel </a>
										<?php //endif ?>
									</div>
								</div>
							</div>
                   ...
                   <table class="table" id="Tabla_paralelos">
                       <thead>
                          <tr> <th>n</th>
                           ...
                           <th>Paralelo</th>
                           <th>Nivel</th>
                           <th>Docente Nombre</th><th>Apellido P</th><th>Materia</th><th>Asignar</th></tr>
                       </thead><tbody>
                        <!--   <tr><td>1 </td>
                           <td>1 </td>
                           <td>A</td>
...
nombre_materia*/
        ...
        dataTable.row.add( [
            ...
            "<a class='btn btn-success btn-xs' ONCLICK='abrir_editar("+'"'+resp[i]["id_aula_paralelo_profesor_materia"]+'*'+resp[i]["profesor_materia_id"]+'*'+resp[i]["aula_paralelo_id"]+'"'+")'><span class='icon-pencil'></span>Editar</a><a class='btn btn-danger btn-xs' onclick='abrir_eliminar("+resp[i]["id_aula_paralelo_profesor_materia"] +")'><span class='icon-trash'></span>Editar</a>"
        ] ).draw( false );
 //
         counter++;
