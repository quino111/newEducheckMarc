...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Crear Asignación Curso/Materia </h2>
						...
						<div class="btn-group">
								...
								<div class="input-group-append be-addon">
									...
									<div class="dropdown-menu">
										...
										<a href="#" class="dropdown-item" ONCLICK='abrir_crear()'>Crear Asignación</a>
										<?php //endif ?>  
										<?php //if ($permiso_imprimir) : ?>
										<div class="dropdown-divider"></div>
										<a href="?/s-curso-paralelo-profesor-materia/imprimir" class="dropdown-item" target="_blank"><span class="glyphicon glyphicon-print"></span> Imprimir Asignacion</a>
										<?php// endif ?>
									</div>
								</div>
							</div>
