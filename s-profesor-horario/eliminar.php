...
if (is_post()) {
	...
	//if (isset($_POST[get_csrf()])) {
		...
		// Obtiene el modo
		$modo = $db->from('ins_horario_profesor_materia')->where('id_horario_profesor_materia', $id_aula_paralelo)->fetch_first();
		...
		if ($modo) {
			...
			$est=$db->query("UPDATE ins_horario_profesor_materia SET estado = 'I', usuario_modificacion = '".$_user['id_user']."', fecha_modificacion = '".$fecha_actual."' WHERE id_horario_profesor_materia = '".$id_aula_paralelo."'")->execute();
